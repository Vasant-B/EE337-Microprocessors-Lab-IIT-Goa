...
RET
;---------------------------------------------------------------
DISPLAYVALUES:  ;Display 50H number of registers starting from the location pointed by 51H
	USING 0
	PUSH PSW
	PUSH AR0
	PUSH AR1
...
SHUFFLEBITS:
	...
	MOV R1, 51H ; Array A start location 
	MOV R0, 52H ; Array B start location
